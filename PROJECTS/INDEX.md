...
| [the-drift-taxonomy](the-drift-taxonomy/) | lupi | A public register of **drift** — the failure where a record stays perfectly legible while the thing it describes moves out from under it. Sixteen specimens across five classes; the newest finding keeps both failures of its own falsification visible. | seed · 16 specimens · Class V edge extended 2026-09-02 · open to contributions |
